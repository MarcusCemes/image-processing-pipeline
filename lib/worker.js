...
/**
 * Split the path and stitch it up
 * exclusively with '/', regardless of
 * the operating system.
 *
 * @param {*} p A RELATIVE path (NO ROOT)
 * @returns A path seperated with '/'
 */
