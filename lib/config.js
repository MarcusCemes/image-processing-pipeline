...
const RIBConfig = function() {
  ...
  this.optimize = true; // apply compression to JPEG and PNG images after resizing
  ...
  this.parse = function(options) {
    ...
    if (!verify_schema()) throw new Error('Bad config. Take a look at the config schema');
  }
